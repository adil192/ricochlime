...
void main() {
  group('New row generation', () {
    test('At least ${RicochlimeGame.minSlimesInRow} and '
        'at most ${RicochlimeGame.maxSlimesInRow} slimes are generated', () {
      final random = Random(12);
      expect(RicochlimeGame.minSlimesInRow,
          lessThan(RicochlimeGame.maxSlimesInRow));
      ...
      for (var _ = 0; _ < 100; ++_) {
        ...
        expect(slimes.length,
            greaterThanOrEqualTo(RicochlimeGame.minSlimesInRow));
